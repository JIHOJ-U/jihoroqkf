  ...
  ko: {
    ...
    aiPreview: {
      ...
      chat: {
        ...
        avatar: 'AI',
        greeting: '안녕하세요! 홈페이지공방의 AI 어시스턴트예요 🌿\n어떤 홈페이지를 만들고 계신가요?',
        questions: {
          businessType: '먼저, 어떤 업종의 홈페이지인가요?',
          siteGoal: '좋아요! 이 사이트의 주요 목표는 무엇인가요?',
          mood: '네, 원하시는 분위기는 어떤 쪽인가요?',
          mustHave: '꼭 필요한 기능이 있으실까요? 없으면 건너뛰셔도 돼요.',
          referenceSite: '참고하고 싶은 사이트 URL이 있으신가요? (선택)',
          email: '마지막으로! 시안을 받아보실 이메일 주소를 알려주세요.',
        },
        skipLabel: '건너뛰기',
        sendLabel: '전송',
        typingLabel: 'AI가 시안을 만들고 있어요',
        resultIntro: '완성됐어요! 아래 시안 확인해보세요 👇',
        fallbackIntro: '앗, 아직 AI 시안 생성 기능은 준비 중이에요.\n대신 사람이 직접 초안을 만들어드릴게요. 상담 페이지로 이어드릴까요?',
  ...
  en: {
    ...
    aiPreview: {
      ...
      chat: {
        botLabel: '> DEV.VIBE AI',
        avatar: 'AI',
        greeting: "Hi! I'm the homepage workshop's AI assistant 🌿\nWhat kind of homepage are you working on?",
        questions: {
          businessType: 'First — what kind of business is the homepage for?',
          siteGoal: 'Nice! What is the main goal of this site?',
          mood: 'Got it. What mood are you going for?',
          mustHave: 'Any must-have features? Feel free to skip.',
          referenceSite: 'Any reference site URL you like? (optional)',
          email: 'Last one! What email should we send the draft to?',
        },
        skipLabel: 'Skip',
        sendLabel: 'Send',
        typingLabel: 'AI is drafting your proposal',
        resultIntro: "Done! Here's your draft below 👇",
        fallbackIntro: "Ah — AI drafting isn't live yet.\nA person will build a draft for you instead. Head to the consultation page?",
